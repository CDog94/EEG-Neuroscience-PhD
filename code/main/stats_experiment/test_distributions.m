...
% Report on all four moments plus Bowley's skewness
fprintf('\nMoment Statistics:\n');
...
% Bowley's Skewness for backward compatibility
fprintf('\nBowley''s Skewness Statistics:\n');
fprintf('  Chi-Squared - Mean: %.4f, Min: %.4f, Max: %.4f\n', ...
    mean(chiSquaredResults.MeasuredBowleySkewness), ...
    min(chiSquaredResults.MeasuredBowleySkewness), ...
    max(chiSquaredResults.MeasuredBowleySkewness));
fprintf('  Weibull - Mean: %.4f, Min: %.4f, Max: %.4f\n', ...
    mean(weibullResults.MeasuredBowleySkewness), ...
    min(weibullResults.MeasuredBowleySkewness), ...
    max(weibullResults.MeasuredBowleySkewness));
fprintf('  Log-normal - Mean: %.4f, Min: %.4f, Max: %.4f\n', ...
    mean(lognormalResults.MeasuredBowleySkewness), ...
    min(lognormalResults.MeasuredBowleySkewness), ...
    max(lognormalResults.MeasuredBowleySkewness));
end